...
public class ProgramEntry
{
    ...
    private static void RunModule(RunOptions opts) {
        ...
        FileSystem  = InterpreterConfig.FileSystem;
        ...
        try {
            ...
            Interpreter.Execute(Ctx, InterpreterConfig.ExecutionScript.ScriptPath, () => {
                ...
                Interpreter.Logger.Info($" - script=\n{Interpreter.Module.MainScript?.FilePath}:0:0");
            });
        }
