...
public class VoltumStatementCodeFragmentElementImpl extends VoltumElementImpl implements VoltumStatementCodeFragmentElement {

  public VoltumStatementCodeFragmentElementImpl(@NotNull IElementType type) {
    super(type);
  }
