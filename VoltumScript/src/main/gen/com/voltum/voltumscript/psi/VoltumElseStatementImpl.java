...
public class VoltumElseStatementImpl extends VoltumElementImpl implements VoltumElseStatement {

  public VoltumElseStatementImpl(@NotNull IElementType type) {
    super(type);
  }
  ...
  public PsiElement getElseKw() {
    return findPsiChildByType(ELSE_KW);
  }
