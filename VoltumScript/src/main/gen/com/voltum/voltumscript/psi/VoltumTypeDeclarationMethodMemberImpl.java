...
public class VoltumTypeDeclarationMethodMemberImpl extends VoltumTypeDeclarationMemberMixin implements VoltumTypeDeclarationMethodMember {

  public VoltumTypeDeclarationMethodMemberImpl(@NotNull IElementType type) {
    super(type);
  }

  public void accept(@NotNull VoltumVisitor visitor) {
    visitor.visitTypeDeclarationMethodMember(this);
  }
  ...
  public PsiElement getAsyncKw() {
    return findPsiChildByType(ASYNC_KW);
  }

  @Override
  @Nullable
  public PsiElement getCoroutineKw() {
    return findPsiChildByType(COROUTINE_KW);
  }
